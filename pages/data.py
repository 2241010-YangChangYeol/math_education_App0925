...
아래는 함수 $f(x) = x^2$의 그래프와, 그 아래 영역을 직사각형으로 근사한 예시입니다.
""")

# 사용자 입력
n = st.number_input("직사각형 개수 (n)", min_value=1, max_value=1000, value=10, step=1,
                    help="1에서 1000 사이의 값을 입력하세요. 값이 커질수록 실제 넓이에 가까워집니다.")
